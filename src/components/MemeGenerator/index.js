    ...
    return (
      <MemeGeneratorForm onSubmit={this.onGenerateMeme}>
        ...
        <CustomInput
          ...
          placeholder="Enter the Input URL"
        />
        ...
        <CustomInput
          ...
          onChange={this.onChangeButtonTextInput}
        ...
        <GenerateButton type="sumbit">Generate</GenerateButton>
      </MemeGeneratorForm>
    )
  }
  renderMeme = () => {
    const {backgroundImageUrl, topText, bottomText, activeFontSizeId} =
      this.state
    return (
      <MemeContainer data-testid="memo" backgroundImage={backgroundImageUrl}>
